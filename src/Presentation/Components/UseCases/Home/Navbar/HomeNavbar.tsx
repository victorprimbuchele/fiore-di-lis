...
export const HomeNavbar: React.FC = () => {
    ...
    return (
        <div className="bg-home-bg-top bg-no-repeat bg-cover bg-center h-full border-b border-b-gold" key="navbar" id="navbar-container">
            ...
            <div className="flex flex-col items-center mt-8 xl:mt-36">
                <h1 className="mt-16 border-b-4 border-b-gold text-white font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl w-fit">
                    FIORE DI LIS
                </h1>
