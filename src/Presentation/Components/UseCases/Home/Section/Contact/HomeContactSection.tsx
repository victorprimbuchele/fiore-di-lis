import locationImage from '../../../../../../assets/Home/Section/Contact/location.png';

export const HomeContactSection: React.FC = () => {
    return (
        <section id='contato' className='text-white px-12 md:px-24 pb-20 md:32 2xl:pb-40' key="contact">
            ...
            <div className='flex flex-col md:flex-row text-white justify-center items-center lg:items-left lg:justify-between'>
                <img src={locationImage} alt='Mapa da localização apresentada no texto ao lado.' className='sm:w-1/2 2xl:w-1/3' />
