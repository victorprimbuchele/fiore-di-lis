import aboutUsSectionImage from '../../../../../../assets/Home/Section/AboutUs/Imagem de restaurante com flor de lis.png';


export const HomeAboutUsSection: React.FC = () => {
    return (
        <section id='sobre-nos' className='text-white px-12 md:px-24' key="about-us">
            ...
            <div className='flex flex-col md:flex-row text-white justify-between'>
                <p className="md:text-xl 2xl:text-2xl md:pe-36 2xl:pe-48 md:leading-8 2xl:leading-10">
                ...
                <img className="pt-4 lg:pt-0" src={aboutUsSectionImage} alt='Fim de tarde com iluminação incandescente. Mesas do lado de fora de um restaurante de pedra.' />
            </div>
