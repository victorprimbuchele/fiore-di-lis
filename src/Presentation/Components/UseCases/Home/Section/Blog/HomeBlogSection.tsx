...
export const HomeBlogSection: React.FC = () => {
  ...
  return (
    <section id='blog' className='text-white lg:px-12 2xl:px-24 bg-almost-black pb-24 lg:pb-40 border-t border-t-gold' key="blog">
      <div className='flex flex-col items-center mb-6'>
        <h2 className='pt-20 lg:pt-24 2xl:pt-40 font-serif text-4xl lg:text-6xl w-fit'>BLOG</h2>
      ...
      <div id="blog-carousel-container" className="flex items-center justify-center">
        ...
        <div className="flex items-center justify-center w-fit sm:gap-x-4 md:gap-x-8 lg:gap-x-12 xl:gap-x-18 2xl:gap-x-24">
          {
